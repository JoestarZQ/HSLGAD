        ...
        for node_b in Na:
            ...
            for node_c in inse:
                ...
                for node_d in Nc:
                    if VFlag[node_d] == 3:
                        # M41
                        nm_dict[node_a][2] += 1/4
                        nm_dict[node_b][2] += 1/4
                        nm_dict[node_c][2] += 1/4
                        nm_dict[node_d][2] += 1/4
...
def load_data(data_source):
    data = sio.loadmat("dataset/{}.mat".format(data_source))
    print(data.keys())
...
if __name__ == '__main__':
    ...
    parser.add_argument('--dataset', default='ogbn-arxiv', choices=['acmv9','citationv1','cora','dblpv7','pubmed'], help='dataset name: cora_both/citationv1_both/dblpv7_both...')
    ...
    scipy.io.savemat("/home/sp429ltx/motif_cola/nCoLA+gae-main/data_motif/{}.mat".format(data_source+'_motif'), {'Network': adj, 'Label': labels,'Attributes':features,'Class':classes,'Motif':motif_feature})
